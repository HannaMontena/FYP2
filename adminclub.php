...
<body id="page-top">
	  ...
	  <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="logout.php">LOGOUT</a></li>
        ...
        <div class="portfolio-item-caption-content text-center text-white"><a href="adminenglish.php" class="button">English</a></div></div>
        ...
        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
        <div class="portfolio-item-caption-content text-center text-white"> <a href="adminmathematic.php" class="button">Mathematic</a></div></div>
        ...
        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
        <div class="portfolio-item-caption-content text-center text-white"><a href="adminhistory.php" class="button">History</a></div></div>
        ...
        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
        <div class="portfolio-item-caption-content text-center text-white"><a href="adminscience.php" class="button">Science</a></div></div>
