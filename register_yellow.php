...
<body id="page-top">
      ...
      <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="logout.php">LOGOUT</a></li>
		...
		<h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Yellow</h2>
		...
		<div class="main">
		<form action="register_yellow1.php" method="post">
		<div id="name">
