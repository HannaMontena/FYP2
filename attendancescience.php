        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
				   ...
				   <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="attendancescience.php">ATTENDANCE</a>
        ...
        <div class="container"><br><br>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/science.png" alt="" />
                        </div>
            ...
            <form action="tblattendace.php" method="post">
               ...
               <table>
                    ...
                    $sql = "SELECT name,level, classroom, gender, year FROM sc";
