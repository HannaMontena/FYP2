...
<body id="page-top" onload="checkEdits15()">
	  ...
	  <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="attendanceyellow.php">ATTENDANCE</a>
      ...
      <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="logout.php">LOGOUT</a></li>
       ...
       <form action="register_yellow.php" method="post">
       <div class="w3-center"><div id="edit15">
       <h3>Tok Janggut</h3>
