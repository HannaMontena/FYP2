...
<body id="page-top" onload="checkEdits15()">
	  ...
	  <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="logout.php">LOGOUT</a></li>
        ...
        <div class="container"><br><br>
         <h2 class="page-section-heading text-center text-uppercase text-white">YELLOW</h2>
       ...
       <div class="w3-center">
	   <div id="edit15" contenteditable="true">
       <h3>Tok Janggut</h3>
       <h5>Slogan<span class="w3-opacity">" Kami Adalah Tok Janggut "</span></h5>
       <br>

      
      <img class="img-fluid" src="assets/img/portfolio/yellow1.jpg" alt="" />
	 ...
	 <div class="card">
	 <div class="container">
     <b>Pn Zuraidi Binti Zainol Abidin</b> 
	 </div>
	 </div><br>
    ...
    <strong>Assistant Leader</strong><br>
     ...
     <b>Pn Noraina Binti Othman</b> 
      ...
      <strong>Committee Members</strong><br>
	   <div class="card">
	 <div class="container">
     <p>Pn Wan Basira Binti Wan </p> 
	 <p>Pn Shahida Bt Wahab</p> 
	 <p>Pn Loh Kim Lian</p> 
	 <p>Cik Ruzila Binti Ahmad Amir</p> 
	 <p>Pn Sharifah Binti Syed</p> 
	 </div>
	 </div><br>
	 
	 
	 </div><br><center><input type="button" class="button1" value="Save Edit" onclick="saveEdits15()"/><div id="update"></center><br></div></div>
     <center><a href="adminyellow1.php" class="button">View</a></center></div></form>
      </div>
      </div>
      </section>
