...
.button {
  ...
  cursor: pointer;
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
         ...
         <h1 class="page-section-heading text-center text-uppercase text-white">View Register Blue</h1>
...
<center><a href="addblue.php" class="button">Add</a><center><br>
<table>
<tr>
  <th>No</th>
    <th>Name</th>
...
<td align="center">
<a href="deleteblue.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Confirm delete this profile ?'); " >Delete</a>
</td>
</tr>
<?php $count++; } ?>
</table></div><br><br>
