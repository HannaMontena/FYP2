...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <h4 >Association:</p><select class="option" name="association">
  <option>Princess Of Islam</option>
   </select></h4><br>
  <input type="submit" name="submit" value="Submit" class="button"> 
  <br><br>
<?php
 if (isset ($_POST['submit'])){
$sql = "INSERT INTO princess (name, age, classroom, gender, association) VALUES ('$name','$age','$classroom','$gender', '$association')";
