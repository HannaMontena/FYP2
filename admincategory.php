...
<body id="page-top">
	  ...
	  <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="logout.php">LOGOUT</a></li>
	   ...
	   <div class="portfolio-item-caption-content text-center text-white">	<a href="adminassociation.php" class="button">Association</a></div></div>
       <img class="img-fluid" src="assets/img/portfolio/2.png" alt="" /></div>
       ...
       <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
       <div class="portfolio-item-caption-content text-center text-white"></div><a href="adminclub.php" class="button">Club</a></div><img class="img-fluid" src="assets/img/portfolio/1.png" alt="" /></div>
       ...
       <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
       <div class="portfolio-item-caption-content text-center text-white"><a href="adminsport.php" class="button">Sport</a></div></div><img class="img-fluid" src="assets/img/portfolio/3.png" alt="" /></div>
	   <div class="text-center mt-4">
       </div>
       </div>
