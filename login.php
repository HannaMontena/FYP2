...
if(isset($_POST['pesan'])){
     if($_POST['pesan']=="LOGIN FAILED"){
	 echo"<div class='alert'>Successful!</div>";}
         else{
...
?>	 
        ...
        <form action="cek_login_teacher.php" method="post"><center>
		...
		<a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#ForgetPassword">Forget Password</a>
