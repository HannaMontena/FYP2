...
<?php
    ...
    <?php
$name = $age = $classroom = $gender = $club = NULL;
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  ...
  <h4 >Club:</p><select class="option" name="club">
...
$sql = "INSERT INTO history (name, age, classroom, gender, club) VALUES ('$name','$age','$classroom','$gender', '$club')";
