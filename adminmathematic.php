...
<body id="page-top" onload="checkEdits3()">
   ...
   <center>
	...
	</div><br><center><input type="button" class="button1" value="Save Edit" onclick="saveEdits3()"/><div id="update"></center><br></div></div>
	<center><a href="adminmathematic1.php" class="button">View</a></center></div>
	</div><br>
    </section>
