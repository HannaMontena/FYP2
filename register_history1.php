...
<html>
<head>
<title>Registration History Form</title>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<body id="page-top">
      ...
      <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Category.php">CATEGORY</a></li>
	   <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="attendancehistory.php">ATTENDANCE</a>
...
$sql = "INSERT INTO history (name,level,classroom,gender,year)
