...
.button {
  ...
  cursor: pointer;
	  ...
	  <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="logout.php">LOGOUT</a></li>
         ...
         <h1 class="page-section-heading text-center text-uppercase text-white">View Register Red</h1>
...
<center><a href="addred.php" class="button">Add</a><center><br>
<table>
 <tr>
  <th>No</th>
    <th>Name</th>
...
<td align="center">
<a href="deletered.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Confirm delete this profile ?'); " >Delete</a>
</td>
</tr>
<?php $count++; } ?>
</table></div><br><br>
