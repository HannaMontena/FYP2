...
<html lang="en">
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title> View Record Bahasa Melayu</title>
...
.button {
  ...
  cursor: pointer;
		...
		<body id="page-top">
         ...
         <h1 class="page-section-heading text-center text-uppercase text-white">View Register Bahasa Melayu</h1>
...
<center><a href="addbm.php" class="button">Add</a><center>
<table>
  <tr>
    <th>No</th>
    <th>Name</th>
...
<td align="center">
<a href="deletebm.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Confirm delete this profile ?'); " >Delete</a>
</td>
</tr>
<?php $count++; } ?>
</table> </div><br><br>
